...
- **Controller Node**:
  - **Drivers**:
    ...
    - **Last Update (`TIME`)**: Timestamp (UOM 151 on IoX 5.8+ / UOM 58 on ISY-994 labeled as "Time since 1980") of the last successful communication/poll with the controller.
...
- **Thermostat Node (`°F` or `°C`)**:
  ...
  - **Last Update (`TIME`)**: Timestamp (UOM 151 on IoX 5.8+ / UOM 58 on ISY-994 labeled as "Time since 1980") of the last data refresh for this thermostat.
  - **Commands**:
